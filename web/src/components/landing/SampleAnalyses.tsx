...
const CARDS: SampleCard[] = [
  {
    ...
    href: "/medicaid?q=How+did+telehealth+spending+change+after+COVID%3F",
    chart: <MedicaidChart />,
  },
  {
    dataset: "medicare",
    ...
    href: "/medicare?q=Which+specialties+have+the+biggest+charge-to-payment+gap%3F",
    chart: <MedicareChart />,
  },
  {
    dataset: "brfss",
    ...
    href: "/brfss?q=How+have+obesity+rates+changed+over+the+past+decade%3F",
    chart: <BRFSSChart />,
  },
  {
    dataset: "nhanes",
    ...
    href: "/nhanes?q=How+does+blood+pressure+vary+by+age+group%3F",
    chart: <NHANESChart />,
  },
];
