...
- COVERAGE NOTE: This dataset covers HCPCS/CPT-billed claims (professional/provider billing). It does NOT include DRG-based hospital facility payments (room & board, OR fees, hospital overhead). However, many hospital-related services ARE queryable: ED visits (99281-99285), inpatient physician services (admission 99221-99223, subsequent care 99231-99233, discharge 99238-99239), surgical CPT codes, and critical care (99291-99292). When a user asks about "hospital costs" or "hospital spending," query these hospital-related HCPCS codes — do NOT refuse. Just note in your output that facility fees are excluded and the numbers reflect the professional/provider component only.
