      ...
      <main className="min-h-screen pt-6 sm:pt-16 pb-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="card p-6 sm:p-8">
            <h2 className="text-lg font-headline font-bold text-foreground mb-4">How it works</h2>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              <div>
                <div className="text-accent font-mono text-sm font-bold mb-2">01</div>
                <h3 className="text-sm font-semibold text-foreground mb-1">Ask a question</h3>
              ...
              <div>
                ...
                <h3 className="text-sm font-semibold text-foreground mb-1">AI generates SQL</h3>
                <p className="text-xs text-muted leading-relaxed font-serif">
              ...
              <div>
                ...
                <h3 className="text-sm font-semibold text-foreground mb-1">See results</h3>
                <p className="text-xs text-muted leading-relaxed font-serif">
